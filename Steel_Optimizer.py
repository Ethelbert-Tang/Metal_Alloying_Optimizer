...
def optimize(j):
    ...
    d = {'Metal':['Al', 'Cu', 'HC_Cr', 'LC_Cr', 'SiCr', 'Ni', 'Mg', 'Nb', 'Mo', 'Si', 'Ti','V', 'NV', 'Mn', 'LC_Mn', 'MC_Mn', 'HC_Mn', 'SiMn'],
    ...
    t = {'Grade':[1000, 1000, 2000, 2000, 3000, 3000, 4000, 4000, 5000, 5000, 6000, 6000, 7000, 7000, 8000, 8000, 9000, 9000, 10000, 10000],
